...
logging_setup()
# Use logging system
logger = logging.getLogger('src.modelling.ChRecogCNNV22')


class ChRecogCNNV22(CNNInterface):
    ...
    def __init__(self, name, input_shape):
        ...
        self.model.add(Conv2D(24, (3, 3), input_shape=input_shape))
        ...
        self.model.add(Conv2D(48, (3, 3), padding="valid"))
        self.model.add(BatchNormalization())
        self.model.add(MaxPooling2D())
        self.model.add(Activation('relu'))
